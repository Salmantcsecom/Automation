...
public class multipleProductsNonConfigGuest {
  ...
  /*  @Test(priority=0)
    ...
    public void multipleProdCod() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProdCoddiscount() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleHazirProduct() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleHazirProductDiscount() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProductCreditCard() throws Exception {
    ...
    public void multipleProductsCreditCardBINCode() throws Exception {
    ...
    public void multipleProductsEasyPayMobileAccount() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void MultipleProductsEasyPayVoucher() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void MultipleProductsJazzCashVoucher() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProductsJazzCashMobileAccount() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProductsCreditCardDiscountCode() throws Exception {
    ...
    public void multipleProductsCreditCardBINDiscountCode() throws Exception {
    ...
    public void multipleProductsEasyPayMobileAccountDiscountCode() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProductsEasyPayVoucherDiscountCode() throws Exception {
        redirectUrl();
        //lp =new loginPage(driver);
        //lp.get();
    ...
    public void multipleProductsJaazCashMobileAccountDiscountCode() throws Exception {
    ...
    public void multipleProductsJaazCashVoucherDiscountCode() throws Exception {
